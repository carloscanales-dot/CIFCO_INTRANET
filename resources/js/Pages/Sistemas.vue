          ...
          <v-row justify="center" class="mb-6">
            <v-col cols="12">
              <h2 style="text-align: center; color: white; font-weight: bold; font-size: 2rem;">
                Servicios informáticos de CIFCO
              </h2>
            </v-col>
          </v-row>
          <v-row justify="center" align="stretch" class="mb-4">
            <v-col cols="12" sm="6" md="4">
              <v-card class="pa-4 text-center" elevation="4" hover clickable to="/soporte-tecnico" rounded="lg">
            ...
            <v-col cols="12" sm="6" md="4">
              <v-card class="pa-4 text-center" elevation="4" href="https://transporte.cifco.gob.sv/users/login" target="_blank" hover rounded="lg">
            ...
            <v-col cols="12" sm="6" md="4">
              <v-card class="pa-4 text-center" elevation="4" hover clickable href="https://documental.cifco.gob.sv" target="_blank" rounded="lg">
                <v-icon size="48" color="primary">mdi-file-document-multiple</v-icon>
                <h3 class="mt-3 mb-1" style="color: #1976d2; font-weight: bold;">Sistemas de inventario</h3>
                <p>Software que permite la administración eficiente de inventarios, control de stock y gestión de pedidos.</p>
              </v-card>
            </v-col>
          </v-row>
          <v-row justify="center" align="stretch">
            <v-col cols="12" sm="6" md="4">
              <v-card class="pa-4 text-center" elevation="4" hover clickable href="https://rh.cifco.gob.sv" target="_blank" rounded="lg">
            ...
            <v-col cols="12" sm="6" md="4">
              <v-card class="pa-4 text-center" elevation="4" hover clickable href="https://marcacion.cifco.gob.sv" target="_blank" rounded="lg">
            ...
            <v-col cols="12" sm="6" md="4">
              <v-card class="pa-4 text-center" elevation="4"  hover clickable href="https://bistro.cifco.gob.sv" target="_blank" rounded="lg">
                <v-icon size="48" color="primary">mdi-hamburger</v-icon>
                <h3 class="mt-3 mb-1" style="color: #1976d2; font-weight: bold;">Sistema de banquetes</h3>
                <p>Sistema de control de banquetes y eventos.</p>
              </v-card>
            </v-col>
          </v-row>
        </v-container>
